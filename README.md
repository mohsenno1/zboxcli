...
44. [Video Streaming](https://github.com/0chain/zboxcli#Video-streaming)
...
Video streaming with zboxcli can be implemented with players for different operating platforms(iOS, Android Mac).Zbox CLI does not have a player itself and use the the downloadFileByBlocks helper function to properly returns file-chunks with correct byte range.
